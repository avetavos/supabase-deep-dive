...
export const quizSecurityChecklist = [
  ...
  },
  {
    ...
    options: [
      'ถูก rate limit หนักกว่า anon key',
      'ข้าม Row Level Security ไปทั้งหมด client ที่ถือ key นี้จะอ่านหรือเขียน row ไหนใน table ไหนก็ได้',
      'ทำงานได้แค่ตอนถูกเรียกจาก Edge Function เท่านั้น ดังนั้นก็แค่ไม่ทำงานใน browser อยู่แล้ว',
      'หมดอายุภายในไม่กี่วินาที ทำให้ไม่มีประโยชน์ใน client code อยู่ดี',
    ],
    answer: 1,
  },
  {
    ...
    options: [
      ...
      'CI apply migration file ที่อยู่ใน version control แบบเดียวกันทุกครั้ง ผ่าน pipeline เดียวกับที่ test บน preview branch มาแล้ว แทนที่จะพึ่งให้คนวาง SQL เข้า production เอง',
