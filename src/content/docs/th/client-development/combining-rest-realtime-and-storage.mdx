...
## Step 2: บันทึก row ที่ reference file นั้น โดยป้องกันด้วย RLS
...
## Step 3: client อีกตัวเห็น row ใหม่แบบ live
...
export const quizCombinedFlow = [
  ...
  },
  {
    ...
    options: [
      ...
      'เพราะ row level security policy จำกัดให้ insert ได้เฉพาะ row ที่ user_id ตรงกับ auth.uid() ที่เป็น mechanism เดียวกับที่ module Auth อธิบายไว้',
  ...
  },
  {
    ...
    options: [
      ...
      'พึ่งพา RLS policy จาก step 2 แทน',
      'พึ่งพาการตั้ง storage bucket ให้เป็น public',
    ],
    answer: 1,
  },
  {
